<header>
    <nav class="flex flex-wrap items-center justify-center md:justify-between mx-auto mb-2">
        ...
        <li class="<?php echo ($activePage === "index") ? 'border-b-2 border-wine' : 'hover:border-b-2 hover:text-wine'; ?> mr-2 md:mr-4">
            <a href="./index.php" aria-current="page">Welcome</a>
        </li>
        <li class="<?php echo ($activePage === "wines") ? 'border-b-2 border-wine' : 'hover:border-b-2 hover:text-wine'; ?> mx-2 md:mx-4">
            <a href="./wines.php" aria-current="page">Wines</a>
        </li>
        <li class="<?php echo ($activePage === "events") ? 'border-b-2 border-wine' : 'hover:border-b-2 hover:text-wine'; ?> mx-1 md:mx-4">
            <a href="./events.php" aria-current="page">Events</a>
        </li>
        <li class="hover:text-wine mx-1 md:mx-4">
        ...
        <li class="hover:text-wine ml-2 md:mx-4">
