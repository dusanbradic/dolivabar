...
<div id="wine-gallery" class="grid grid-cols-2 lg:grid-cols-5 gap-1 md:gap-0 justify-items-center">
    ...
    <div class="relative flex object-cover overflow-hidden bg-no-repeat bg-cover mb-4 rounded-lg hover:rounded-none">
        <div class="group relative">
            ...
            <div class="absolute inset-0 flex items-center justify-center invisible group-hover:visible group-hover:border group-hover:border-wine">
    ...
    <!-- <div class="relative flex object-cover overflow-hidden bg-no-repeat bg-cover mb-4">
        <div class="group relative">
            <img src="assets/images/vino6.png" class="w-full h-80 object-cover transition duration-500 ease-in-out group-hover:scale-110"  alt="flasa vina">
            <div class="absolute inset-0 flex items-center justify-center invisible group-hover:visible">
                <ul>
                    <li>
                        <p><strong>Proizvodjac:</strong> Milanovi vinogradi</p>
    ...
    <div class="relative flex object-cover overflow-hidden bg-no-repeat bg-cover mb-4">
        <div class="group relative">
            <img src="assets/images/vino7.png" class="w-full h-80 object-cover transition duration-500 ease-in-out group-hover:scale-110"  alt="flasa vina">
            <div class="absolute inset-0 flex items-center justify-center invisible group-hover:visible">
                <ul>
                    <li>
                        <p><strong>Proizvodjac:</strong> Milanovi vinogradi</p>
    ...
    <div id="load-more-btn" class="text-center w-full">
